...
class ProxyConfig(BaseModel):
    ...
    server: str = Field(default="127.0.0.1:1080", description="SOCKS5代理地址(host:port或域名:port，可省略协议前缀)")
    ...
    exclude_media: bool = Field(default=False, description="聊天媒体（图片/视频）下载不走代理，直连")
